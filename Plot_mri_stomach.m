...
set(gcf, 'Position', [0 0 550 450], 'Color', 'w')
i=i+1;
plot(mri_stomach(1:9,1),mri_stomach_norm_bh1(1:9,i),'DisplayName','s1 exp1','LineStyle','-','Color',[0 0 1],'LineWidth',1.2,'Marker','o','MarkerFaceColor',[0 0 1]); hold on;
i=i+1;
plot(mri_stomach(1:10,1),mri_stomach_norm_bh1(1:10,i),'DisplayName','s1 exp2','LineStyle','--','Color',[0 0 1],'LineWidth',1.2,'Marker','o'); hold on;
i=i+1;
plot(mri_stomach(1:10,1),mri_stomach_norm_bh1(1:10,i),'DisplayName','s2 exp1','LineStyle','-','Color',[1 0 0],'LineWidth',1.2,'Marker','s','MarkerFaceColor',[1 0 0]); hold on;
i=i+1;
plot(mri_stomach(1:10,1),mri_stomach_norm_bh1(1:10,i),'DisplayName','s2 exp2','LineStyle','--','Color',[1 0 0],'LineWidth',1.2,'Marker','s'); hold on;
i=i+1;
plot(mri_stomach(1:10,1),mri_stomach_norm_bh1(1:10,i),'DisplayName','s3 exp1','LineStyle','-','Color',[0 0.6 0],'LineWidth',1.2,'Marker','^','MarkerFaceColor',[0 0.6 0]); hold on;
i=i+1;
plot(mri_stomach(1:10,1),mri_stomach_norm_bh1(1:10,i),'DisplayName','s3 exp2','LineStyle','--','Color',[0 0.6 0],'LineWidth',1.2,'Marker','^'); hold on;
